...
| `drain` | `components/drain/README.md` | processor | logs | Alpha | Clusters log bodies with the Drain algorithm, annotates each record with a derived template, and can extract named masked values plus remaining `<*>` positions. |
